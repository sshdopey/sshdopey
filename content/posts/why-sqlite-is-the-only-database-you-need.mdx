...
I'm going to make a controversial claim: for 90% of applications, SQLite is not just sufficient — it's _optimal_.
...
Here's what you _don't need_ with SQLite:
...
Notice what's _not_ on this list: "my app has users," "I need joins," "I need transactions," "I want ACID guarantees." SQLite has all of those.
...
Start with SQLite. Migrate when you have a _specific, measurable_ reason. You'll be surprised how long "when" takes to arrive.
