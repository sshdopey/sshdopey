...
Every year I refine my development environment. I'm not chasing novelty — I'm chasing _friction reduction_. Every second I spend fighting my tools is a second I'm not thinking about the problem.
...
After years of pure Neovim, I moved to Cursor with Neovim keybindings. The AI integration is genuinely useful — not for writing code, but for _navigating_ code. "Find where this error originates" and "explain this legacy function" are queries I run dozens of times a day.
